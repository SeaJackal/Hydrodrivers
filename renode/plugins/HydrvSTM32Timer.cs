...
//
// Based on renode-infrastructure commit ec0b8b45bcba6c40963c3f05af5efd3b82fd5297.
// Local fix: EGR.UG transfers the preloaded ARR value to the active timer limit.
...
namespace Antmicro.Renode.Peripherals.Timers
{
    ...
    public class HydrvSTM32Timer : LimitTimer, IDoubleWordPeripheral, IKnownSize, INumberedGPIOOutput, IRegisterablePeripheral<IGPIOReceiver, NumberRegistrationPoint<int>>, IRegisterablePeripheral<IGPIOReceiver, NullRegistrationPoint>, IGPIOReceiver
    {
        public HydrvSTM32Timer(IMachine machine, ulong frequency, uint initialLimit) : base(machine.ClockSource, frequency, limit: initialLimit, direction: Direction.Ascending, enabled: false, eventEnabled: true, autoUpdate: false)
        {
            ...
            var registersMap = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.EventGeneration, new DoubleWordRegister(this)
                    .WithFlag(0, FieldMode.WriteOneToClear, writeCallback: (_, val) =>
                    {
                        ...
                        // STM32 update events transfer the ARR preload into the active limit.
                        Limit = autoReloadValue;
        ...
        {
            public CaptureCompareChannel(HydrvSTM32Timer parent, int index)
            {
                this.parent = parent;
                Index = index;
                Connection = new GPIO();
            ...
            private readonly HydrvSTM32Timer parent;
        }
