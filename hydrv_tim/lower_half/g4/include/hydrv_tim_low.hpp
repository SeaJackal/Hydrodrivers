...
public:
    static constexpr TimerPreset TIM1_low{TIM1_BASE, 6, RCC_APB2ENR_TIM1EN,
                                          RCC_BASE +
                                              offsetof(RCC_TypeDef, APB2ENR)};
    static constexpr TimerPreset TIM3_low{TIM3_BASE, 2, RCC_APB1ENR1_TIM3EN,
                                          RCC_BASE +
...
inline void TimerLow::Init()
{
    ...
    reinterpret_cast<TIM_TypeDef *>(TIMx_)->BDTR = TIM_BDTR_MOE;
